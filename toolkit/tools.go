...
// PushJSONToRemote posts arbitrary data to some URL as JSON, and returns the response, stauts code and error if any.
// The final parameter, client, optional. If none if specified, we use the standard http.Client
